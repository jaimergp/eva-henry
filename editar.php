...
// configuration
$url = 'http://localhost/henry/editar.php';
$file = 'apuntados.txt';
...
<html>
	<head>
		<title>¡NUESTRO SÍ!</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		<meta name="description" content="Enlace entre Eva y Henry" />
		<meta name="keywords" content="boda Eva Henry" />
	...
	<body class="index">
		...
		<header id="header" class="alt">
			<h1 id="logo"><a href="/index.html"><span>Nuestro</span> SÍ</a></h1>
			<nav id="nav">
				<ul>
